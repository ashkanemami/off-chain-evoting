 ...
 */
 library BJJ {
     ...
     uint256 public constant Q = 21888242871839275222246405745257275088548364400416034343698204186575808495617; // p in JS
     uint256 public constant H = 10944121435919637611123202872628637544274182200208017171849102093287904247808; // H=(Q+1)/2
     uint256 public constant S = 2736030358979909402780800718157159386076813972158567259200215660948447373041; // subOrder
     ...
     //  * @return elliptic curve addition p3 = _p1 + _p2
     //  */
     ...
     //  * @return point _p doubled p = 2 * _p (elliptic cruve multiplication)
     //  */
     ...
     //  * @return elliptic curve subtraction p3 = _p1 - _p2
     //  */
     function afSub(uint256[2] memory _p1, uint256[2] memory _p2) internal view returns (uint256[2] memory p3) {
      ...
      */
     function afOnCurve(uint256[2] memory _p) internal pure returns (bool) {
     ...
     //  * @return (x,y) the point in its decompresed form
     //  */
     ...
     //  * @return p which is the extended form of the point represented by uint256[4]
     //  */
     ...
     //  * @return point _p doubled p = 2 * _p (elliptic cruve multiplication) extended from
     //  */
     function exDouble(
         uint256 _x,
         uint256 _y,
     ...
     //  * @param _d scalar value
     //  * @return extended form of point p = d * p (elliptic curve multiplication)
     //  */
     ...
     //  * @return compressed form of point p = d * p (elliptic curve multiplication)
     //  */
