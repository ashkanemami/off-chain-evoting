...
const {subOrder, order, Base8, F, addPoint, mulPointEscalar, inSubgroup, inCurve, packPoint, unpackPoint} = require("./node_modules/circomlib/src/babyjub.js");
...
function keyGen(secret){
    ...
    if (typeof secret === 'bigint') {
        ...
        return {'infield': secretValInField, 'Public_point': pointOnCurve , 'Public_key': compressedPointInt};
